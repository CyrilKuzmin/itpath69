...
type Service interface {
	CreateComment(ctx context.Context, user, text string, module, part int) error
...
func (s *service) CreateComment(ctx context.Context, user, text string, module, part int) error {
